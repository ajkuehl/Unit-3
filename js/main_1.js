...
// // choropleth legend
// function setLegend(csvData, colorScale,colorClasses, domainArray){
// //   var legend = d3.select("body")
// //       .append('svg')
// //       .attr("width", chartWidth)
// //       .attr("hieght", chartHeight)
// //       .attr("class", "legend");
// //
//
...
//
//   // remove "endcaps" of the x-axis on legend
//   g.select(".domain")
//       .remove();
//
//   // draw legend
